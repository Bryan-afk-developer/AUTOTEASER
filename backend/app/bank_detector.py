...
# The 8 valid banks for this project
VALID_BANKS = ["hsbc", "bbva", "banorte", "santander", "scotiabank", "banamex", "inbursa", "sabadell"]
...
TEXT_FALLBACK_PATTERNS = [
    ...
    ("santander", ["bancosantanderm"]),
    ("banorte", ["enlace negocios"]),
    ("bbva", ["cash management m.n"]),
    ("banamex", ["cuenta de cheques moneda nacional"]),
