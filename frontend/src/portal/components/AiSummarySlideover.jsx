...
export default function AiSummarySlideover({ isOpen, onClose, aiSummary }) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div 
            ...
            className="fixed right-0 top-0 h-full w-full max-w-md bg-[#111113] border-l border-border shadow-2xl z-[910] flex flex-col overflow-y-auto custom-scrollbar"
          >
            ...
            <div className="flex items-center gap-3 px-6 py-4 border-b border-border bg-surface relative overflow-hidden">
